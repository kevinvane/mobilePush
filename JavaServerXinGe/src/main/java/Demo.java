...
//        System.out.println(t.demoDeleteAllTokensOfAccount());
    ...
    protected JSONObject demoPushSingleAccount() {
        Message message = new Message();
        message.setExpireTime(86400);
        message.setTitle("你好吗");
        message.setContent("哈哈哈哈哈哈哈");
        message.setType(Message.TYPE_MESSAGE);
        JSONObject ret = xinge.pushSingleAccount(0, "samwen", message);
        return ret;
    }
    ...
    public Demo() {
        xinge = new XingeApp(2100197984, "0cdad536ce3c9c9af2a75db9b6164b43");
        //buildMesssges();
    }
